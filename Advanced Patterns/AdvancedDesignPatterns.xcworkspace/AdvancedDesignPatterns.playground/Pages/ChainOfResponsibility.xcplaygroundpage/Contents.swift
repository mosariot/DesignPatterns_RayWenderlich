...
public class Coin {
    ...
    public class var standardDiameter: Double { 0 }
    public class var standardWeight: Double { 0 }
    
    public var centValue: Int { 0 }
    public final var dollarValue: Double {
        Double(centValue) / 100
    }
...
extension Coin: CustomStringConvertible {
    ...
    public var description: String {
        String(format: "%@ {diameter: %0.3f, dollarValue: $%0.2f, weight: %0.3f}", "\(type(of: self))", diameter, dollarValue, weight)
    }
}

public class Penny: Coin {
    
    public override class var standardDiameter: Double { 19.05 }
    public override class var standardWeight: Double { 2.5 }
    public override var centValue: Int { 1 }
}

public class Nickel: Coin {
    
    public override class var standardDiameter: Double { 21.21 }
    public override class var standardWeight: Double { 5.0 }
    public override var centValue: Int { 5 }
}

public class Dime: Coin {
    
    public override class var standardDiameter: Double { 17.91 }
    public override class var standardWeight: Double { 2.268 }
    public override var centValue: Int { 10 }
}

public class Quarter: Coin {
    
    public override class var standardDiameter: Double { 24.26 }
    public override class var standardWeight: Double { 5.670 }
    public override var centValue: Int { 25 }
}
...
public class VendingMachine {
    ...
    public func insertCoin(_ unknownCoin: Coin) {
        ...
        print("Coins Total Weigth: \(weight) g")
        print("")
    }
}
...
let nickerHandler = CoinHandler(coinType: Nickel.self)
let dimeHandler = CoinHandler(coinType: Dime.self)
let quarterHandler = CoinHandler(coinType: Quarter.self)

pennyHandler.next = nickerHandler
nickerHandler.next = dimeHandler

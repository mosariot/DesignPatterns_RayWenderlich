...
public struct Email {
    ...
    public let recipienEmail: String
...
public struct EmailFactory {
    ...
    public func createEmail(to recipient: JobApplicant) -> Email {
        ...
        case .rejected:
            subject = "Thanks for Your Your Application"
            messageBody = "Thank you gor applying, \(recipient.name)! " + "We have decided to move forward with other candindates. " + "Please remember to wear pants next time!"
        }
        
        return Email(subject: subject, messageBody: messageBody, recipienEmail: recipient.email, senderEmail: senderEmail)
    }
}
